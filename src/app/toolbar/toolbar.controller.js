(function ()
{
  ...
  /** @ngInject */
    ...
    function ToolbarController($rootScope, $mdSidenav,$state, $scope,$translate, $mdToast,AuthService,$timeout,toolBarService)
  {
    var vm = this;
    vm.signOut = signOut;
   vm.state = $state;
   $scope.$on('$stateChangeSuccess', function ()
   {
     ...
     vm.searchOff = vm.currentState=='group' || vm.currentState=='skill' || vm.currentState=='region' || vm.currentState=='service' || vm.currentState=='adminPreferenceSetting' || vm.currentState=='ecmPreferenceSetting'; 
   });
    // Data
    $rootScope.global = {
      search: ''
